...
/* Vérifie que tout lien interne de dist/*.html résout vers un fichier
   ...
   volontairement 404 (orienteur, confidentialite). Vérifie aussi que les
   ancres #id ciblent un id existant dans la page de destination. */
"use strict";
...
var PAGES_404_PREVUES = ["orienteur.html", "confidentialite.html"];
